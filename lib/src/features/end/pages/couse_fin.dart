...
class course_fin extends StatefulWidget {
  const course_fin({Key? key}) : super(key: key);

  @override
  State<course_fin> createState() => _course_finState();
}

class _course_finState extends State<course_fin> {
  @override
                  ...
                  SizedBox(height: 30,),
                   ...
                   SizedBox(height: 30,),
                      ...
                      Container(
                        ...
                        mainAxisAlignment: MainAxisAlignment.spaceBetween,
                          children: [
                            Container(child: Text('4000 CFA',style: TextStyle(fontSize: 50,fontWeight: FontWeight.bold,color: Colors.red),)),
